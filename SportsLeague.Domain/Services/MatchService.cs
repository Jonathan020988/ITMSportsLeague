...
public class MatchService : IMatchService//6 dependencias inyectadas, match tiene relacion con todas
{
    ...
    private readonly ILogger<MatchService> _logger;//hacerle monitoreo 
    ...
    public async Task<Match> CreateAsync(Match match)// tiene muchas reglas de negocio
    {
    ...
    public async Task UpdateStatusAsync(int id, MatchStatus newStatus)//le paso el id i el estado del partido
    {
