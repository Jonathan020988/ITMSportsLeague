...
public class StandingsService : IStandingsService// dependencias
{
    ...
    public async Task<object> GetStandingsAsync(int tournamentId)
    {
        ...
        //el toDictionary para crear un dicccionario a partir de la lista de resultados
        //donde la clave es el matchid y el valor es el matchresult correspondiente
        //permite acceder rapidamente al resultado de un partido de un partido dado su id sin tener que recorrer la lista
        ...
        var standings = tournamentTeams.Select(tt =>
        {
            ...
            //count me sirve para contar el numero de elementos en la coleccion
            //que cumplen una condicion espesifica
            //en este caso, se cuentan cuantos partidos como local(homematches)
            //resultaron en una victoria para el equipo
            //cuantos partidos tuvieron mas goles a favor (homegols) que en contra(awaygoals)
