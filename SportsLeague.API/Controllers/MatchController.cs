...
[ApiController]// este decorador es el que me define que esta clase es de tipo controlador de una api rest
[Route("api/[controller]")]//ruta url; ruta base: api/match
public class MatchController : ControllerBase
{
    ...
    [HttpGet("tournament/{tournamentId}")]//get api/match/tournament/id
